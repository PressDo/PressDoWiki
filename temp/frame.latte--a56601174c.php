...
/** source: skin/frame.latte */
final class Templatea56601174c extends Latte\Runtime\Template
{
...
';
		if ($wiki->page->view_name == 'wiki') /* line 15 */ {
			echo '        <link rel="stylesheet" href="/skin/namumark.css">
...
';
		...
		foreach ($configArray['auto_css_targets']['*'] as $sf) /* line 24 */ {
			echo '        <link rel="preload" as="style" href="/skin/liberty/';
			echo LR\Filters::escapeHtmlAttr($sf) /* line 25 */;
			echo '">
        <link rel="stylesheet" href="/skin/liberty/';
...
';
		...
		foreach ($configArray['auto_js_targets']['*'] as $sf) /* line 28 */ {
			echo '        <link rel="preload" as="script" href="/skin/liberty/';
			echo LR\Filters::escapeHtmlAttr($sf['path']) /* line 29 */;
			echo '">
        <script defer src="/skin/liberty/';
