    ...
    public static function get(string $type='text', string $query='', $from=null, int $until=1): array
    {
        ...
        try{
            if (!empty($query) && $type == 'author') {
                $a = $db->prepare("SELECT b.id,b.executor_m,b.executor_i,b.target_ip,b.mask,b.target_member,b.target_aclgroup,b.target_id,b.comment,b.`datetime`,b.until,b.`action`,b.granted
                ...
                $sql = "SELECT b.id,b.executor_m,b.executor_i,b.target_ip,b.mask,b.target_member,b.target_aclgroup,b.target_id,b.comment,b.`datetime`,b.until,b.`action`,b.granted
                FROM `BlockHistory` b JOIN member ON member.uuid = b.target_member AND member.username LIKE ?
                UNION SELECT b.id,b.executor_m,b.executor_i,b.target_ip,b.mask,b.target_member,b.target_aclgroup,b.target_id,b.comment,b.`datetime`,b.until,b.`action`,b.granted
                ...
                $a = $db->query("SELECT id,executor_m,executor_i,target_ip,mask,target_member,target_aclgroup,target_id,comment,`datetime`,until,`action`,granted FROM `BlockHistory` WHERE $sqlstr ORDER BY id ASC LIMIT 100");
            }
