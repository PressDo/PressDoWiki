...
class GeoIP
{
    ...
    private static function init(): void
    {
        if(empty(static::$geoip)) {
            static::$geoip = new Reader(Config::get('geoip2_database'));
        }
    }
    ...
    {
        self::init();
        return static::$geoip->country($ip)->country->isoCode;
    }
    ...
    public static function get(string $ip): string
    {
        ...
        } elseif (file_exists(Config::get('geoip2_database'))) {
